...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/yecttoikage6577)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/yecttoikage6577
```

A live public deployment of this template is available at [https://yecttoikage6577.templates.workers.dev](https://yecttoikage6577.templates.workers.dev)
